  ...
  $.fn.audioPlayer = function( params )
  {
    ...
    this.each( function()
    {
      ...
      thePlayer.find( '.' + cssClass.playPause ).on( 'click', function()
      {
        ...
        {
          $( this ).attr( 'title', params.strPlay ).find( 'a' ).html( '<span class="fa-stack fa-lg"> <i class="fa fa-circle fa-stack-2x text-danger"></i> <i class="fa fa-play fa-stack-1x fa-inverse"></i></span>' );
          thePlayer.removeClass( cssClass.playing ).addClass( cssClass.stopped );
          isSupport ? theAudio.pause() : theAudio.Stop();
        }
        else
        {
          $( this ).attr( 'title', params.strPause ).find( 'a' ).html( '<span class="fa-stack fa-lg"> <i class="fa fa-circle fa-stack-2x text-danger"></i> <i class="fa fa-pause fa-stack-1x fa-inverse"></i> </span>' );
