...
d=c.find(".modal-body"),g="",e={onEscape:b.onEscape};if(k(b.buttons,function(b,c){g+="<div class='"+("ok"===b?"col-xs-12":"col-xs-6")+" "+("cancel"===b?"pull-left":"")+"'><button data-bb-handler='"+b+"' type='button' class='col-xs-12 btn "+("ok"===b?"btn-sm":"")+" "+c.className+"'>"+c.label+"</button></div>";e[b]=c.callback}),d.find(".bootbox-body").html(b.message),!0===b.animate&&c.addClass("fade"),b.className&&c.addClass(b.className),b.title&&d.before("<div class='modal-header'><h4 class='modal-title'></h4></div>"),b.closeButton){var l=
