...
var TimeGridEventRenderUtils = {
	...
	*/
	checkEventRendering: function(start, end) {
		...
		var isMatch = this.checkEventRenderingMatch(expectedRects, eventEls);
	...
	checkEventRenderingMatch: function(expectedRects, eventEls) {
	...
	computeSpanRects: function(start, end) {
		var dayStructs = this.computeDays();
		var slotStructs = this.computeSlots();
		var dayI, dayStruct;
