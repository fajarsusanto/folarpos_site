...
class Profile extends MY_Controller {
    ...
    private $url_index = "dash-manage/mg-profile";
    private $title_param = "Profile";
    ...
    public function index() {
        ...
        $data['content'] = "mg_profile/profile_index";
    ...
    public function save() {
        ...
        $this->form_validation->set_rules('apps_desc', '', 'required');
