                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <div class="input-group">
                                        <span class=""></span>
                                        <textarea id="elm1" class="form-control" name="apps_term" placeholder="Description"><?php echo empty($sess['app']->apps_term) ? null : ucwords($sess['app']->apps_term); ?></textarea>
                                    </div>                    
                                </div>
        ...
        $.ajax({
            ...
            success: function (json) {
                if (json.status == 0) {
                    ...
                    $("#load-form").load('<?php echo base_url("dash-manage/mg-term/form") ?>');
                }
