...
<div class="panel panel-default">
    <div class="panel-heading">
        <h6 class="panel-title txt-dark"><b style="margin: 0px"><i class='fa <?php echo $act == 'EDIT' ? 'fa-pencil' : 'fa-plus'; ?> mr-10'></i> <?php echo $act; ?> TESTIMONY</b></h6>
    </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-wrap">
                        ...
                        <?php if (!empty($dt)) { ?>
                            <input type="hidden" name="id" value="<?php echo md5($dt->testi_id) ?>"/>
                        <?php } ?>
                        <div class="row">   
                                ...
                                <div class="row">
                                    <div class="row">
                                        <div class='col-xs-6'>
                                            <div style="overflow: hidden; height: 135px; border: 3px solid grey; width: 96%; margin-left: 15px; margin-bottom: 15px;">
                                                <a class="fancybox-buttons fancybox-photo" data-fancybox-group="button" href="<?php echo (!empty($dt->testi_photo) ? (file_exists($dt->testi_photo) ? (base_url($dt->testi_photo)) : base_url("assets-ds/square.jpg")) : base_url("assets-ds/square.jpg")) ?>">
                                                    <img id="preview-photo" style="width: 100%; min-height: 100%; margin-top: 0px; margin-left: 0px" src="<?php echo (!empty($dt->testi_photo) ? (file_exists($dt->testi_photo) ? (base_url($dt->testi_photo)) : base_url("assets-ds/square.jpg")) : base_url("assets-ds/square.jpg")) ?>">    
                                                </a>
                                            </div>
                                        </div>
                                        <div class="col-xs-6">
                                            <span class="app__user-notif mt-20">
                                                <div class="row" style="border-left: 3px dotted black; height:95px;">
                                                    <label for="photo-input" style="font-size:12px; margin-left: 20px;">
                                                        ...
                                                        <span>Upload photo .jpg *<br/><small><i>Compress your photo *</i></small></span>
                                                    </label>
                                                </div>
                                                <input type="file" id="photo-input"/>
                                                <input type="hidden" name="file_header" value='<?php echo (!empty($dt->testi_photo) ? base64_encode_image(base_url($dt->testi_photo)) : null) ?>'/>
                                            </span>
                                            <div class="row">
                                    ...
                                    <div class="col-xs-12 mb-10">
                                        ...
                                        <div class="input-group input-group-sm">
                                            ...
                                            <select name="prod_id" class="reseter-option" data-placeholder="Product" data-style="btn-white">
                                                <option value=""></option>
                                                <?php foreach ($prod as $r_nom => $row) : ?>
                                                    <option value="<?php echo $row->prod_id; ?>" <?php echo empty($dt) ? null : ($dt->prod_id == $row->prod_id ? "selected" : null) ?> ><?php echo ucwords($row->prod_name); ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        </div>
                                    </div>
                                    <div class='col-xs-12 mg-t-md'>
                                        <div class="form-group">
                                            <label>Testi Name *</label>
                                            <div class="input-group">
                                                <span class="input-group-addon"><i class="fa fa-pencil"></i></span>
                                                <input type="text" name="testi_name" maxlength="150" value="<?php echo empty($dt) ? null : ucwords($dt->testi_name) ?>" class="form-control" placeholder="Testi Name">
                                            </div>                    
                                        </div>
                                    </div>
                                    <div class='col-xs-12'>
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <span class=""></span>
                                                <textarea id="elm1" class="form-control" name="testi_desc" placeholder="Description"><?php echo empty($dt) ? null : ucwords($dt->testi_desc); ?></textarea>
                                            </div>                    
                                        </div>
                                    </div>                
                                    <div class='col-xs-12 mg-t-md'>
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-addon"><i class="fa fa-pencil"></i></span>
                                                <input type="text" name="testi_caption" maxlength="150" value="<?php echo empty($dt) ? null : $dt->testi_caption ?>" class="form-control" placeholder="Caption">
                                            </div>                    
                                        </div>
                                    </div>
                                </div>
        ...
        $.ajax({
            ...
            success: function (json) {
                if (json.status == 0) {
                    ...
                    $("#load-form").load('<?php echo base_url("dash-manage/mg-testimony/form") ?>');
                    $("#load-data").load('<?php echo base_url("dash-manage/mg-testimony/data") ?>');
                }
