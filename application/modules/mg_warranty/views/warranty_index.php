            ...
            <div class="col-sm-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h6 class="panel-title txt-dark"><i class="fa fa-th-large mr-10"></i> DATA WARRANTY</h6>
                    </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-12 mg-b-sm">
                                        <div class="input-group">
                                            ...
                                            <input type="text" onkeyup="sorSup()" name="sort_data" class="form-control" placeholder="Filter Warranty Name...">
                                        </div>
                                    </div>                                                        
                                </div>                                         
                            </div>
