...
<div class="panel panel-default">
    <div class="panel-heading">
        <h6 class="panel-title txt-dark"><b style="margin: 0px"><i class='fa <?php echo $act == 'EDIT' ? 'fa-pencil' : 'fa-plus'; ?> mr-10'></i> <?php echo $act; ?> Privacy</b></h6>
    </div>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <div class="input-group">
                                        <span class=""></span>
                                        <textarea id="elm1" class="form-control" name="apps_privacy" placeholder="Description"><?php echo empty($sess['app']->apps_privacy) ? null : ucwords($sess['app']->apps_privacy); ?></textarea>
                                    </div>                    
                                </div>
        ...
        $.ajax({
            ...
            success: function (json) {
                if (json.status == 0) {
                    ...
                    $("#load-form").load('<?php echo base_url("dash-manage/mg-privacy/form") ?>');
                }
