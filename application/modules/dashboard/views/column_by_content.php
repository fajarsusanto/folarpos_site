...
<div class="col-lg-12 col-md-12 col-sm-12 ">
    <div id="container_prod"  style="margin: 0 auto; padding-bottom: 20px"></div>
</div>
<script>
    Highcharts.chart('container_prod', {
    chart: {
        type: 'column'
    },
    title: {
        text: 'VISITOR CONTENT'
    },
    subtitle: {
