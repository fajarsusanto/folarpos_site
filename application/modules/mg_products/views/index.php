...
<div class="row">
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <h6 class="panel-title txt-dark"><b style="margin: 0px"><i class="fa fa-users mr-10"></i> DATA PRODUCTS</b></h6>
        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12 mg-b-sm">
                            <div class="input-group input-group-sm">
                                ...
                                <input type="text" onkeyup="sorUs('input')" name="sort_data" class="form-control" placeholder="Filter Data Products...">
                            </div>
                        </div>
                        <div class="col-lg-2 col-md-2 hidden-sm hidden-xs">
                            <table class="no-border">
                                <tr>
                                    ...
                                    <td><small style="color: grey">Total<hr style="margin: 0px; padding: 0px"/>Products</small></td>
                                </tr>
                            </table>
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12 mg-b-sm hidden-xs">
                            <button type="button" onclick="actionM('add')" class="btn btn-success col-xs-12" data-toggle="modal" data-target=".bs-example-modal-lg"><i class="fa fa-plus mr-10"></i> ADD PRODUCTS</button>
                        </div> 
