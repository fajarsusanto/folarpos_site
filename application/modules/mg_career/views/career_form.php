<link rel="stylesheet" type="text/css" href="<?php echo base_url() ?>assets-ds/datetime_picker/jquery.datetimepicker.css"/>
<script src="<?php echo base_url(); ?>assets-ds/datetime_picker/jquery.datetimepicker.full.js"></script>
...
<div class="panel panel-default">
    <div class="panel-heading">
        <h6 class="panel-title txt-dark"><b style="margin: 0px"><i class='fa <?php echo $act == 'EDIT' ? 'fa-pencil' : 'fa-plus'; ?> mr-10'></i> <?php echo $act; ?> CAREER</b></h6>
    </div>
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mg-b-md">
                                                ...
                                                <input type="text" name="date_publish" maxlength="150" value="<?php echo empty($dt) ? null : date("d-m-Y H:i", strtotime($dt->cont_date)) ?>" class="datepicker1 form-control" placeholder="Publish">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mg-b-md">
                                                <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                                <input type="text" name="date_expired" maxlength="150" value="<?php echo empty($dt) ? null : date("d-m-Y H:i", strtotime($dt->cont_date_expired)) ?>" class="datepicker2 form-control" placeholder="Expired">
                                            </div>
                                        </div>
                                    </div>
                                </div>
