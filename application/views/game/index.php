<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="<?php echo base_url('assets-ds/game/css/demo.css') ?>" />
		<link rel="stylesheet" type="text/css" href="<?php echo base_url('assets-ds/game/css/game.css') ?>" />
		<script type="text/javascript" src="<?= base_url() ?>assets-ds/game/js/TweenMax.min.js"></script>
		<script type="text/javascript" src="<?= base_url() ?>assets-ds/game/js/three.min.js"></script>
		<script type="text/javascript" src="<?= base_url() ?>assets-ds/game/js/game.js"></script>
		<!--[if IE]>
...
<!--			<a class="demo-link" href="part1.html">Part 1</a>
		...
		<div class="partisan">
			...
			<a class="partisan__link" href="https://goo.gl/oECseP" rel="nofollow">
				<img class="partisan__img" src="<?= base_url() ?>assets-ds/game/img/Partisan_Bushel.png" alt="Bushel: Easily manage all your Apple devices at work"/>
