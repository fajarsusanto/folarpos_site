            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="hero-section" style="margin-top: 120px">
                        <h3 class="text-white" style="border-bottom: 1px solid white; padding-bottom: 10px; margin-bottom: 0px"><?php echo ucfirst($tips_dt->cont_title) ?></h3>
                        <p class="text-white" style="letter-spacing: 1px; font-size: 14px; padding-right: 10px">Publised : <?php echo indo_date($tips_dt->cont_date, 1, 1) ?> - Created By : <?php echo ucfirst($tips_dt->users_fullname) ?></p>
                        <div class="btn-box">
                ...
                <div class="col-md-6">
                    <img src="" style="width: 80%; margin-top: 0px"/>
                </div>
            </div>
        </div>                   
    </div>
        ...
        <div class="wrapper-sm">
            <div class="row">
                <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                    ...
                    <h2 style="border-bottom: 1px solid grey; padding-bottom: 10px; margin-bottom: 5px"></h2>
                </div>
