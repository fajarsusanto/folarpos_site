<style>
    ...
    .header{
        background: url("assets-ds/bg-3.jpg") no-repeat center top fixed;
...
======================================================= -->
    <div class="container">
        <div class="wrapper-xs">
            <div class="row">
                <div class="col-md-12">
                    <h2 style="border-bottom: 1px solid grey; padding-bottom: 10px; margin-bottom: 5px; color:#B22222">Karir</h2>
            ...
            <div class="row">
                <!-- Team Box -->
                <?php foreach ($tips as $k => $val) { ?>
                    <div class="col-sm-3 team-box">
                        <a href="<?php echo site_url("career/" . $val->cont_url) ?>">
                        <div class="team-img">
                            <img src="<?php echo base_url() ?><?php echo $val->cont_header ?>" class="img-responsive" alt="">
                        </div>
                        </a>
                        <h4><a href="<?php echo site_url("career/" . $val->cont_url) ?>"><?php echo $val->cont_title ?></a></h4>
