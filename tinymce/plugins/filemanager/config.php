...
$base_url = "http://folarpos.co.id/"; //url base of site if you want only relative url leave empty
$upload_dir = '/folarpos/assets/images/'; // path from base_url to upload base dir
$current_path = '../../../assets/images/'; // relative path from filemanager folder to upload files folder
